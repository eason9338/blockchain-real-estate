...
import "../src/IssueDAO.sol"; // ✅ 新增提案與投票治理的 DAO
...
contract DeployScript is Script {
    function run() external {
        ...
        // Step 3：取得所有房產代幣的地址
        PropertyTokenFactory.PropertyInfo[] memory all = factory
            .getAllProperties();
        ...
        // Step 4.5：部署治理提案用的 IssueDAO（綁定第一個房產代幣）
        IssueDAO issueDAO = new IssueDAO(firstTokenAddr, deployer);
        console.log("IssueDAO deployed at:", address(issueDAO));
        ...
        console.log(
            "Initialization completed: tokens distributed and marketplace listings created"
        );
